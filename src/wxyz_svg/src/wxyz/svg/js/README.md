...
```bash
pip install wxyz_svg  # or conda, or mamba
```

## Developer Installation

The public API of the widgets in `@deathbeds/wxyz-svg` are not yet fully documented.
...
```bash
jupyter labextension install @jupyter-widgets/jupyterlab-manager @deathbeds/wxyz-svg
