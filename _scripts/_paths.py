...
PY_SETUP_TEXT = '''
""" generated setup for wxyz_{{ name }} """
# this file is autogenerated, do not edit by hand
# see setup.cfg and package.json for actual data
import json
from pathlib import Path
WXYZ_NAME = "{{ name }}"
...
EXT_FILES[str(SHARE)] += [f"src/wxyz/{WXYZ_NAME}/install.json"]
...
'''
PY_SETUP_TEMPLATE = jinja2.Template(PY_SETUP_TEXT)


INSTALL_JSON_TEXT = """{
  "packageManager": "python",
  "packageName": "wxyz_{{ name }}",
  "uninstallInstructions": "Use `pip/conda uninstall wxyz_{{ name }}`"
}"""
INSTALL_JSON_TEMPLATE = jinja2.Template(INSTALL_JSON_TEXT)
