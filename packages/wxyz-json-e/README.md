...
[project]
dependencies = [
    "wxyz_json_e",                     # but probably pinned sensibly
]
```
...
```yaml
{ 'devDependencies': {
      '@deathbeds/wxyz-json-e': '*', # but probably pinned sensibly
    }, 'jupyterlab': { 'sharedPackages': { '@jupyter-widgets/base': { 'bundled': false, 'singleton': true }, '@jupyter-widgets/controls': { 'bundled': false, 'singleton': true }, '@deathbeds/wxyz-json-e': { 'bundled': false, 'singleton': true } } } }
```
