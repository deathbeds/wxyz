...
The public API of the widgets in `@deathbeds/wxyz-tpl-nunjucks` are not yet fully
...
```bash
jupyter labextension install @jupyter-widgets/jupyterlab-manager @deathbeds/wxyz-tpl-nunjucks
